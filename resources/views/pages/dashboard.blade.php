...
@section('main-content')
    ...
    <div class="text-center">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target=".create_area">
            Create Area
        </button>
    </div>
                    ...
                    <form action="api/createzone" method="post" id="add_zone_form">
                        ...
                        <div class="zone-box">
                            ...
                            <div class="form-input">
                                ...
                                <input type="textr" class="zone_id_input" name="zone_id" style="width: 95%"
                                    autocomplete="off" placeholder="Input Zone Number">
                            </div>
                            ...
                            <div class="field_groups">
                                <div class="row extra_fields position-relative">
                                    <div class="col-lg-6">
                                        <div class="form-input">
                                            <label for="">Name</label><span class="text-danger">*</span><br>
                                            <input type="text" name="district_name[]" class="district_name_input">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-input">
                                            <label for="">Code</label><span class="text-danger">*</span><br>
                                            <input type="text" name="district_code[]" class="district_code_input">
                                        </div>
                                    </div>
    ...
    <!-- Create Area Modal -->
    <div class="modal fade zone-modal create_area" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
